...
```{python}
#del [[rezedu]] # Eliminamos el data.frame "rezedu"  
rezedu.to_csv(current_directory + '/Output/Data/' + 'ic_rezedu22_2.csv', index = False)
```
...
numeric_columns = ['parentesco', 'trab', 'edad', 'act_pnea1', 'act_pnea2', 'ocupa1', 'ocupa2', 'atemed', 
...
salud[numeric_columns] = convert_to_numeric(salud, numeric_columns)
...
```{python}
def construir_indicador(poblacion):
    # Convirtiendo variables string a numéricas
    ...
    return (poblacion.copy()
                     ...
                     .pipe(integrar_bases)
                     .pipe(convertir_a_numerico, columnas = columnas_a_convertir)
                     .pipe(calcular_pea)
                     .pipe(tipo_trabajo)
...
# Asumiendo que 'poblacion', 'prestaciones', y 'pensiones' ya están definidos

seguridad_social = construir_indicador(poblacion)
    
                             
# Seleccionar columnas finales
seguridad_social = seguridad_social[['folioviv', 'foliohog', 'numren', 'tipo_trab1', 'tipo_trab2', 'aforlab1', 'aforlab2', 'pea', 'jub', 'smlab1',
'smlab2', 'smcv', 'aforecv', 'ss_dir', 'par', 'jef_ss', 'cony_ss', 'hijo_ss', 's_salud', 'pam', 'ing_pam', 'ic_segsoc']]
```
...
### Profundidad en el espacio del bienestar económico {.tabset .tabset-pills .top3-tiles}  
