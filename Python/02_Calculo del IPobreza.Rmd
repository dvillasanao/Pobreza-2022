...
# Define una función para calcular las variables auxiliares
...
# Define una función para realizar el agrupamiento y cálculo de las variables relacionadas con acceso a servicios de salud
...
# Usa funciones de tuberías para encadenar las operaciones
salud_procesado = (
    poblacion.copy()
...
#Convirtiendo variables string a numericas
prestaciones[['subor', 'indep', 'tiene_suel', 'pago', 'pres_8', 'id_trabajo']
             ] = prestaciones[['subor', 'indep', 'tiene_suel', 'pago', 'pres_8', 'id_trabajo']
                              ].apply(pd.to_numeric, errors = 'coerce')
...
## Independientes que reciben un pago
prestaciones.loc[((prestaciones['subor'] == 2) & (prestaciones['indep'] == 1) & 
                  (prestaciones['tiene_suel'] == 1)), 'tipo_trab'] = 2
prestaciones.loc[((prestaciones['subor'] == 2) & (prestaciones['indep'] == 2) & 
                  (prestaciones['pago'] == 1)), 'tipo_trab'] = 2

## Independientes que no reciben un pago
prestaciones.loc[((prestaciones['subor'] == 2) & (prestaciones['indep'] == 1) & 
                  (prestaciones['tiene_suel'] == 2)), 'tipo_trab'] = 3
prestaciones.loc[((prestaciones['subor'] == 2) & (prestaciones['indep'] == 2) & 
                  ((prestaciones['pago'] == 2) | (prestaciones['pago'] == 3))), 'tipo_trab'] = 3
...
**Se guarda la base de datos** 
```{python}
calidad_viviendas.to_csv(current_directory + '/Output/Data/' + '/ic_cev22.csv.csv', index = False)
```
...
**Se guarda la base de datos** 
```{python}
servicios_basicos.to_csv(current_directory + '/Output/Data/' + '/ic_sbv22.csv.csv', index = False)
```
...
**Se guarda la base de datos** 
```{python}
menores_alimentacion.to_csv(current_directory + '/Output/Data/' + '/menores22.csv.csv', index = False)
```
...
**Se guarda la base de datos** 
```{python}
alimentacion.to_csv(current_directory + '/Output/Data/' + '/ic_ali22.csv.csv', index = False)
```
